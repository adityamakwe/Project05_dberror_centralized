...
class MarksheetCtl(BaseCtl):
    ...
    def save(self, request, params={}):
        try:
            ...
            pk = int(self.form['id'])
            uniqueAttrib = {"rollNumber" : self.form['rollNumber']}
    ...
    #                     duplicate = self.get_service().duplicate(self.form['rollNumber'],pk)
    #                     if duplicate:
    #                         res["success"] = False
    ...
    #                     duplicate = self.get_service().duplicate(self.form['rollNumber'])
    #                     if duplicate:
    #                         res["success"] = False
    #                         res["result"]["message"] = "Roll Number already exists"
    #                         return JsonResponse(res)
